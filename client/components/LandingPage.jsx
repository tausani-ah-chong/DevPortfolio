      ...
      <div className='h-screen w-full flex items-center lg:pb-32 xl:pb-80 '>
        <div className='w-full lg:h-72 xl:h-96 flex justify-center'>
          <div className=' lg:w-96 lg:ml-auto lg:pt-10 xl:pt-20 '>
            <div className='flex'>
              <span className='flex items-center bg-blue-200 rounded-md lg:h-10 xl:h-12 px-3 lg:mr-1 lg:mt-1 text-white font-extrabold lg:text-4xl focus:outline-none'>Dev</span>
