          ...
          {currentUser ? <span className="flex relative order-1"><button onClick={handleLogOut} className="buttonBlue absolute right-0 xl:text-lg lg:text-base">Log Out</button></span>
            : <span className="flex relative order-1">
              <div className="flex items-center ml-auto">
                <Link to='/login'>
                  <button className="flex items-center xl:ml-2 hover:bg-blue-400 bg-blue-200 rounded-md lg:h-8 px-3 lg:font-medium xl:font-semibold focus:outline-none lg:text-base">Sign in</button>
                </Link>
                <Link to='/signup'>
