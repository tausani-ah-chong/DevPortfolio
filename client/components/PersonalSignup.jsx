        ...
        <div>
          <div className="w-auto h-96 bg-gray-200 flex flex-cols p-12 rounded-md">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="inputDiv">
                <input className="inputBox h-8 text-xl " placeholder="Profile Picture" id='profilePicture' type='file' name='profilePicture' accept="image/png, image/jpeg" />
              </div>

              <p>Profile Picture</p>
              <button className="my-6 flex items-center mr-auto hover:bg-yellow-200 bg-blue-200 rounded-md h-10 px-3 font-semibold text-lg">Next</button>
